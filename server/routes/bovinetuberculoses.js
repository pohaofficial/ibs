...
let BovineTuberculosis = require('../models/bovinetuberculosis.model');

router.route('/').get((req, res) => {
  BovineTuberculosis.find()
    .then(bovinetuberculoses => res.json(bovinetuberculoses))
...
router.route('/add').post((req, res) => {
  ...
  const newEntry = new BovineTuberculosis({
    username,
    description,
    duration,
    date,
